module Api
  module V1
    class PlantsController < BaseController
      ...
      def plant_params
        params.require(:plant).permit(:name, :device_id, :public, :light_min, :light_max, :temp_min, :temp_max, :humidity_min, :humidity_max, :fertilizing, :repotting, :pruning, :common_diseases, :appearance, :blooming_time)
      end
    end
  end
end

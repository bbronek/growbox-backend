module Api
  module V1
    class PlantsController < BaseController
      ...
      def plant_params
        params.require(:plant).permit(:name, :device_id, :public, :light_min, :light_max, :temp_min, :temp_max, :air_humidity_min, :air_humidity_max, :fertilizing, :repotting, :pruning, :common_diseases, :appearance, :blooming_time, :image)
      end
    end
  end
end
